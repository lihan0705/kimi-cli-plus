...
def plugin_list():
    ...
    from kimi_cli.plugin import get_project_plugin_dir, get_user_plugin_dir
...
@cli.command("remove")
def plugin_remove(name: Annotated[str, typer.Argument(help="Name of the plugin to remove.")]):
