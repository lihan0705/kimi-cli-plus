...
from kimi_cli.knowledge.classifier import Classifier
...
async def test_classifier_with_model_name():
    with (
        patch("kimi_cli.knowledge.classifier.load_config") as mock_load_config,
        patch("kimi_cli.knowledge.classifier.OAuthManager"),
